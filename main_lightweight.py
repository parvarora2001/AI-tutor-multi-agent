...
# Import the lightweight model loader
import sys
sys.path.append('models')
from model_loader_lightweight import ModelLoader
...
def main():
    print("🚀 Starting Tutor Agent with lightweight models...")
    print("💡 This version uses the smallest possible models to avoid memory issues")
    ...
    try:
        ...
        with open("session_results_lightweight.json", "w") as f:
            json.dump(results, f, indent=2)
        
        print("\n✅ Session complete! Results saved to session_results_lightweight.json")
        
    except KeyboardInterrupt:
        print("\n\n👋 Session interrupted by user. Goodbye!")
    except Exception as e:
        print(f"\n❌ An error occurred: {e}")
        print("💡 This lightweight version should work on most systems.")
